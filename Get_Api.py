...
def get_league_id():
    ...
    for i in range(len(data)):
        ...
        insert_query = \
            f"INSERT INTO Leagues VALUES('{leauge_id}', '{leauge_name}', '{leauge_region}')"
...
def get_team_statistics():
    ...
    for i in range(16, Team_range):
        ...
        insert_query = \
            f"INSERT INTO Statistics VALUES('{Teams[i]}',  '{Player_id}', '{Player_name}', '{Player_number}', '{Player_age}',\
                                            '{Player_position}', '{Player_injured}', '{Player_minutes}', '{Player_appearences}',\
